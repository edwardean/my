...
#define kOnImageName @"/Bundle.bundle/Resources/rosettaon"
#define kOffImageName @"/Bundle.bundle/Resources/rosettaoff"
#define kLeafImageName @"/Bundle.bundle/Resources/rosetta_leaf"
...
- (void)layoutSubviews {
    ...
    _wheelButton.frame = CGRectMake(CGRectGetMidX(rect) - 12.0f,
                                    CGRectGetMidY(rect) - 12.0f, 30.0, 30.0f);
}
...
- (void)addLeaves {
    ...
    [_items enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
        ...
        layer.frame = CGRectMake(0.0f, 0.0f, /*49,44*/image.size.width, image.size.height);
...
- (void)expand {
    ...
    for (NSInteger i=0; i<[_items count]; i++) {
        ...
        CGPoint point = CGPointMake(0.37*97.0f * cos(angle) + CGRectGetMidX(self.bounds), 0.37*97.0f * sin(angle) + CGRectGetMidY(self.bounds));
