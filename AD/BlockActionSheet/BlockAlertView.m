...
+ (void)initialize
{
    ...
    {
        background = [UIImage imageNamed:kAlertViewBackground];  //kAlertViewBackground 表示的是  @"alert-window.png"
        background = [[background stretchableImageWithLeftCapWidth:0 topCapHeight:kAlertViewBackgroundCapHeight] retain]; 
                                                                //kAlertViewBackgroundCapHeight 表示的是   38
        titleFont = [kAlertViewTitleFont retain];            //kAlertViewTitleFont 表示  [UIFont boldSystemFontOfSize:20]
        messageFont = [kAlertViewMessageFont retain];       //kAlertViewMessageFont 表示 [UIFont systemFontOfSize:18]
        buttonFont = [kAlertViewButtonFont retain];         //kAlertViewButtonFont  表示 [UIFont boldSystemFontOfSize:18] bold与没有bold的区别
    }
}
